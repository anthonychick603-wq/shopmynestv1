...
const styles = StyleSheet.create({
  ...
  // v1.0.225 — New Listing refinement. Every option tile becomes a
  // white card with a hairline border; dashed "add" tiles keep the
  // Notion-upload metaphor; labels use micro tokens for a consistent
  // section rhythm.
  top: {
    flexDirection: "row",
    alignItems: "center",
  ...
  photoAddText: { ...typeTokens.caption, color: colors.brand, fontSize: 11, fontWeight: "700" },
  ...
  videoAddText: { ...typeTokens.body, color: colors.brand, fontWeight: "700" },
  videoTile: {
    flexDirection: "row",
    alignItems: "center",
    gap: spacing.md,
  ...
  videoThumbText: { ...typeTokens.body, flex: 1, fontWeight: "600" },
  ...
  videoRemoveText: { ...typeTokens.caption, color: colors.error, fontWeight: "700" },
  label: { ...typeTokens.micro, marginTop: spacing.md, marginBottom: spacing.sm },
  categoryHint: { ...typeTokens.caption, marginBottom: spacing.xs },
  ...
  sizeText: { ...typeTokens.body, color: colors.onSurface, fontWeight: "600" },
  ...
  customizableTitle: { ...typeTokens.h3 },
  customizableSubtitle: { ...typeTokens.caption, marginTop: spacing.xs },
  duplicateBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  duplicateBtnText: { ...typeTokens.body, color: colors.brand, fontWeight: "800" },
});

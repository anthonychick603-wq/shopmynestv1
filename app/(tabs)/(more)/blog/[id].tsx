  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.top}>
        <TouchableOpacity onPress={() => safeBack(router, "/(tabs)/(more)/blog")} style={styles.topBtn} testID="blog-detail-back" accessibilityRole="button" accessibilityLabel="Go back" hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>
...
// v1.0.226 — Blog post detail refinement. Post card + composer field
// move to white + hairline. Comment rows keep their clean list form.
const styles = StyleSheet.create({
  ...
  postAuthor: { ...typeTokens.body, fontWeight: "800" },
  postDate: { ...typeTokens.caption, marginTop: 1 },
  postCaption: { ...typeTokens.bodyLg, color: colors.onSurface, lineHeight: 22 },
  postImage: { width: "100%", height: 240, borderRadius: radius.field, backgroundColor: colors.surfaceTertiary, marginTop: spacing.md },
  commentsHeader: { flexDirection: "row", alignItems: "center", gap: spacing.md, marginTop: spacing.md, paddingTop: spacing.md, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.hairline },
  metaChip: { flexDirection: "row", alignItems: "center", gap: 6 },
  commentsHeaderText: { ...typeTokens.caption, fontWeight: "700" },
  ...
  author: { ...typeTokens.body, fontWeight: "800", flexShrink: 1 },
  date: { ...typeTokens.caption },
  content: { ...typeTokens.body, marginTop: 2 },
  composer: {
    flexDirection: "row",
    alignItems: "flex-end",
    gap: spacing.sm,
  ...
  signInText: { ...typeTokens.body, flex: 1, color: colors.onSurfaceMuted },

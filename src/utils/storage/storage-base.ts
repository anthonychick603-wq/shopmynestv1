...
// Any JSON-serializable value: values round-trip through JSON.stringify/parse,
// so nested objects and arrays (e.g. the cart items list, a saved address) are
// supported — not just primitives.

...
const styles = StyleSheet.create({
  ...
  top: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: spacing.md }, topTitle: { fontWeight: "800", fontSize: 17, color: colors.onSurface },
  topBtn: { width: 40, height: 40, borderRadius: radius.pill, alignItems: "center", justifyContent: "center", backgroundColor: colors.surfaceSecondary, ...shadows.card },
  summary: { flexDirection: "row", alignItems: "baseline", gap: spacing.sm, paddingBottom: spacing.lg }, summaryStars: { fontSize: 27, fontWeight: "800", color: colors.brand }, summaryText: { color: colors.onSurfaceMuted, fontSize: 14 },
  card: { padding: spacing.md, borderRadius: radius.md, backgroundColor: colors.surfaceSecondary, marginBottom: spacing.md }, row: { flexDirection: "row", alignItems: "center", gap: spacing.sm }, avatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: colors.surfaceTertiary }, name: { fontWeight: "700", color: colors.onSurface }, stars: { color: colors.brand, fontSize: 15 }, date: { color: colors.onSurfaceMuted, fontSize: 12 },
  verified: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: spacing.sm }, verifiedText: { color: colors.success, fontWeight: "700", fontSize: 12 }, variation: { color: colors.onSurfaceMuted, fontSize: 12, marginTop: spacing.sm }, body: { color: colors.onSurface, lineHeight: 21, marginTop: spacing.sm },
  photoRow: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm, marginTop: spacing.md }, thumbnail: { width: 74, height: 74, borderRadius: radius.sm, backgroundColor: colors.surfaceTertiary },
  response: { borderLeftWidth: 3, borderLeftColor: colors.brand, backgroundColor: colors.surfaceTertiary, padding: spacing.sm, marginTop: spacing.md, borderRadius: radius.sm }, responseTitle: { fontSize: 12, fontWeight: "800", color: colors.onSurface, marginBottom: 3 }, responseBody: { color: colors.onSurface, lineHeight: 19 },
  more: { alignSelf: "center", paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, borderRadius: radius.pill, backgroundColor: colors.surfaceSecondary }, moreText: { fontWeight: "700", color: colors.brand },
  viewer: { flex: 1, backgroundColor: "rgba(0,0,0,0.95)", alignItems: "center", justifyContent: "center" }, viewerImage: { width: "100%", height: "100%" }, close: { position: "absolute", top: 52, right: spacing.lg, width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.16)" }, nav: { position: "absolute", top: "48%", width: 46, height: 46, alignItems: "center", justifyContent: "center", borderRadius: 23, backgroundColor: "rgba(255,255,255,0.16)" },
});

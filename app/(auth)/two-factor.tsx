...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 14, color: colors.onSurfaceMuted, marginBottom: spacing.sm, lineHeight: 20 },
  hint: { fontSize: 12, color: colors.onSurfaceMuted, marginBottom: spacing.md },
